...
export const TOPICAL_MAP: readonly TopicalNode[] = [
  ...
  {
    path: "/demo",
    topic: "Self-service product demo",
    role: "commercial",
    parentPath: "/pricing",
    childPaths: ["/pricing", "/sample-dossier", "/how-it-works"],
    covers: [
      "self-service software demo",
      "deterministic calculations and QC",
      "evidence linking and digital outputs",
      "no consulting or advisory included",
    ],
    ...chainExtras("/demo"),
  },
  {
    ...
    role: "spoke",
    parentPath: "/",
    childPaths: ["/sample-dossier", "/product", "/demo"],
    covers: [
  ...
  },
  {
    ...
    role: "spoke",
    parentPath: "/",
    childPaths: ["/legal-notice", "/security", "/case-studies", "/pricing"],
    covers: [
  ...
  },
  {
    ...
    covers: [
      ...
      "room is larger only when earned",
