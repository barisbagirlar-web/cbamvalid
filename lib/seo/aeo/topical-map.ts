...
export const TOPICAL_MAP: readonly TopicalNode[] = [
  ...
  },
  {
    ...
    role: "commercial",
    parentPath: "/pricing",
    childPaths: ["/pricing", "/sample-dossier", "/security", "/enterprise", "/contact"],
    covers: ["human demo path", "Enterprise contact sales only"],
    ...chainExtras("/demo"),
  },
  {
    path: "/enterprise",
    topic: "Enterprise Exclusive — SSO SLA Holding",
    role: "commercial",
    parentPath: "/pricing",
    childPaths: ["/enterprise/sso", "/enterprise/holding", "/partners", "/security", "/demo"],
    covers: ["SSO IdP federation", "SLA draft", "holding multi-entity", "from $12000"],
    ...chainExtras("/enterprise"),
  },
  {
    path: "/enterprise/sso",
    topic: "Enterprise SSO / IdP federation",
    role: "spoke",
    parentPath: "/enterprise",
    childPaths: ["/enterprise", "/security", "/demo"],
    covers: ["OIDC SAML", "Entra Google Okta"],
    ...chainExtras("/enterprise/sso"),
  },
  {
    path: "/enterprise/holding",
    topic: "Holding / multi-entity Enterprise scope",
    role: "spoke",
    parentPath: "/enterprise",
    childPaths: ["/enterprise", "/pricing", "/demo"],
    covers: ["holding entitlement", "explicit seal scope"],
    ...chainExtras("/enterprise/holding"),
  },
  {
    path: "/partners",
    topic: "Channel partner intake",
    role: "spoke",
    parentPath: "/enterprise",
    childPaths: ["/enterprise", "/sample-dossier", "/verifier-review"],
    covers: ["partner inquiry", "no invented logos"],
    ...chainExtras("/partners"),
  },
  {
    path: "/case-studies",
  ...
  },
  {
    ...
    role: "spoke",
    parentPath: "/",
    childPaths: ["/privacy", "/buyer-link", "/legal-notice", "/trust"],
    covers: [
  ...
  {
    path: "/trust",
    topic: "Trust evidence registry",
    role: "spoke",
    parentPath: "/",
    childPaths: ["/legal-notice", "/security", "/verifier-review", "/case-studies", "/pricing"],
    covers: [
      "pinned marketing claims",
      "SAMPLE vs VERIFIED discipline",
      "visible OWNER ACTION gaps",
    ],
    ...chainExtras("/trust"),
  },
  {
    ...
    role: "spoke",
    parentPath: "/",
    childPaths: ["/rulesets", "/product", "/methodology", "/enterprise"],
    covers: [
      "CBAM is the live door",
      "Enterprise expands the room under SOW",
      "second category not a public half-product",
    ],
...
const LABEL_BY_PATH: Record<string, string> = {
  ...
  "/trust": "Trust Evidence Registry",
  "/enterprise": "Enterprise Exclusive",
  "/enterprise/sso": "Enterprise SSO",
  "/enterprise/holding": "Holding / multi-entity",
  "/partners": "Partners",
