...
const STATIC_ROUTES: readonly RouteDraft[] = [
  ...
  },
  {
    ...
    audience: ["exporters", "data preparers", "prospects"],
    sitemapEligible: true,
  ...
  },
  {
    ...
    description:
      "CBAMValid security facts: europe-west1 hosting, TLS, Art. 28 subprocessors, support targets, status links, and a DPA draft. ISO 27001 / SOC 2 are not claimed.",
  ...
  },
  {
    ...
    pageType: "legal",
    indexability: "index",
    title: "Service Status | Cloud Dependency Facts | CBAMValid",
    description:
      "CBAMValid service status: Google Cloud / Firebase europe-west1 dependency facts, provider status links, and incident contact. No invented uptime percentage.",
    h1: "Service status — dependency facts",
    canonicalPath: "/status",
    primaryIntent: "CBAMValid service status",
    audience: ["procurement", "customers", "security reviewers"],
    sitemapEligible: true,
    schemaTypes: ["WebPage", "BreadcrumbList"],
