...
function buildSteel(uid, caseId) {
  ...
  const evidence = [
    ...
    evidenceRecord({
      ...
      reportingPeriod: "2026",
      linkedInputs: ["directEmissions", "installation.systemBoundaries", "installation.monitoringPlanId"],
    ...
    evidenceRecord({
      ...
      reportingPeriod: "2026",
      linkedInputs: ["directEmissions", "carbonPriceRecords.0.amountPaid", "carbonPriceRecords.0.applicableEmissions"],
  ...
  const data = {
    ...
    installation: {
      ...
      monitoringPlanId: datum("MP-IN-PRT-2026-001", undefined, ids.direct),
    },
    ...
    methodologyDecisions: [
      {
        ...
        approverName: "Owner verification (synthetic seed)",
...
function buildCement(uid, caseId) {
  ...
  const data = {
    ...
    installation: {
      ...
      monitoringPlanId: datum("MP-EG-AIS-2026-001", undefined, ids.direct),
    },
...
function buildAluminium(uid, caseId) {
  ...
  const data = {
    ...
    installation: {
      ...
      monitoringPlanId: datum("MP-CN-KMG-2026-001", undefined, ids.direct),
    },
