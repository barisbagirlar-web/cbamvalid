  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-12 font-sans text-foreground">
      ...
      <section className="space-y-6">
        ...
        <p className="text-sm text-muted leading-relaxed">
          Our mission is to simplify the compilation of embedded emissions data, ensuring that technical calculations adhere deterministically to the latest regulatory benchmarks and methodologies. We bridge the gap between industrial production facilities and EU compliance requirements by structuring data into the O3CI field-mapped structured data export format.
        </p>
