          ...
          <div className="border-t border-border bg-background p-6 md:px-10">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm leading-relaxed text-muted">
                CBAMValid prepares data and evidence for independent verification. It does not issue an accredited verification opinion, customs approval, EU approval or acceptance guarantee. Paddle processes payment as Merchant of Record.
              </p>
            </div>
          </div>
        </div>
