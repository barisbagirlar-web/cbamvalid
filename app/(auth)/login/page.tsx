      ...
      <div className="w-full max-w-md animate-in fade-in">
        ...
        <div className="bg-surface border border-border rounded-xl p-10 shadow-[var(--shadow-card)]">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              <label htmlFor="email" className="block text-xs font-semibold text-foreground uppercase tracking-wider mb-2">Corporate Email</label>
              <input
                id="email"
                type="email"
                value={email}
            ...
            <div>
              <label htmlFor="password" className="block text-xs font-semibold text-foreground uppercase tracking-wider mb-2">Password</label>
              <input
                id="password"
                type="password"
                value={password}
          ...
          >
            <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="currentColor">
              ...
              <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 0 3.99 3.47 2.18 7.06l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335"/>
            </svg>
            Sign In with Google
          </button>
        </div>
