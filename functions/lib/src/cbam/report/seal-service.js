...
async function sealReport(params) {
    const reportRef = (0, admin_1.getAdminDb)().collection("cbam_reports").doc();
    const reportId = reportRef.id;
    // Phase 1: Reserve the entitlement (Atomic)
    await (0, admin_1.getAdminDb)().runTransaction(async (dbTransaction) => {
    ...
    try {
        ...
        await (0, admin_1.getAdminDb)().runTransaction(async (dbTransaction) => {
            ...
            const sealRef = (0, admin_1.getAdminDb)().collection("document_seals").doc(documentHash);
