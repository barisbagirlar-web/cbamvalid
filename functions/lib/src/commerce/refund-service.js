...
async function processRefund(dbTransaction, params) {
    const orderRef = (0, admin_1.getAdminDb)().collection("commerce_orders").doc(params.orderId);
    ...
    const entitlementsQuery = await dbTransaction.get((0, admin_1.getAdminDb)().collection("entitlements").where("orderId", "==", params.orderId));
