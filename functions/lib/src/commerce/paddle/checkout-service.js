...
async function createCheckout(uid, email, productCode, metadata) {
    ...
    const result = await (0, firebase_admin_1.getAdminDb)().runTransaction(async (dbTransaction) => {
    ...
    await (0, firebase_admin_1.getAdminDb)().collection("commerce_orders").doc(result.orderId).update({
