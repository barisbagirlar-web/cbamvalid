...
async function createEntitlement(dbTransaction, params) {
    ...
    const entitlementRef = (0, admin_1.getAdminDb)().collection("entitlements").doc();
...
async function reserveEntitlement(dbTransaction, params) {
    ...
    const entitlementRef = (0, admin_1.getAdminDb)().collection("entitlements").doc(params.entitlementId);
