...
async function createOrder(dbTransaction, params) {
    ...
    const orderRef = (0, admin_1.getAdminDb)().collection("commerce_orders").doc();
    ...
    dbTransaction.set((0, admin_1.getAdminDb)().collection("commerce_orders").doc(orderId), order);
    return order;
}
/**
...
async function transitionOrderStatus(dbTransaction, orderId, newStatus, metadata) {
    ...
    const orderRef = (0, admin_1.getAdminDb)().collection("commerce_orders").doc(orderId);
