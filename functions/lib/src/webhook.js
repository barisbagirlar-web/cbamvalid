...
exports.paddleWebhook = (0, https_1.onRequest)({
    ...
    try {
        ...
        const eventRef = (0, firebase_admin_1.getAdminDb)().collection("paddle_events").doc(eventId);
        const duplicate = await (0, firebase_admin_1.getAdminDb)().runTransaction(async (dbTransaction) => {
