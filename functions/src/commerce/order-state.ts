...
export const ORDER_TRANSITIONS: Readonly<Record<OrderStatus, readonly OrderStatus[]>> = Object.freeze({
  ...
  REPORT_CALCULATED: ["REPORT_SEALED", "ENTITLED", "REFUNDED_AFTER_DELIVERY"],
  REPORT_SEALED: ["DELIVERED", "ENTITLED", "REFUNDED_AFTER_DELIVERY"],
  DELIVERED: ["ENTITLED", "REFUNDED_AFTER_DELIVERY"],
