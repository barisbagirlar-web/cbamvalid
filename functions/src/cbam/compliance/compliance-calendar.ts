/**
 * Server-runtime mirror of lib/cbam/compliance-calendar.ts.
 * The product-facing UI consumes lib/cbam/compliance-calendar.ts as the single
 * source of truth; this module mirrors the exact milestone dataset so the sealed
 * PDF can render the compliance calendar without drifting from the UI. Parity is
 * enforced by tests/integration/compliance-calendar-parity.test.ts.
 */
