...
function enterprisePdfArtifacts(params: {
  ...
  const tocTable = {
    ...
    widths: [12, 78, 90],
    rows: [
      [1, "Report contents", "Complete result set mapped section by section"],
      [2, "Scope and identity", "Parties, installation, production route and reporting period"],
      [3, "Goods population", "Per-good CN codes, allocation shares and allocated emissions"],
      [4, "Calculation summary", "Reported embedded-emissions totals and specific intensities"],
      [5, "Calculation provenance", "Ruleset, engine version, allocation reconciliation and root hash"],
      [6, "Authoritative readiness state", "Single enterprise readiness field and its reasons"],
      [7, "Preparation score", "Automated preparation score and scoring formula"],
      [8, "Evidence assurance", "A-E grades with independent-verifiability and metadata checks"],
      [9, "Findings and closure", "Open findings with priority, owner, state and closure conditions"],
      [10, "Methodology decisions", "Selected methods, rejected alternatives and legal basis"],
      [11, "Registry template mapping", "CBAM registry field mapping with status and evidence lineage"],
      [12, "Scenario analysis and materiality simulation", "Deterministic +/-10% scenarios and % intensity deltas"],
      [13, "Materiality proximity", "Per-good 5% planning-threshold utilization"],
      [14, "Compliance calendar", "Definitive-period certificate, holding and declaration milestones"],
      [15, "Operator sign-offs", "Operator roles, names and signed-at timestamps"],
      [16, "Verifier handover", "First-meeting open questions and closure conditions"],
      [17, "Primary-document architecture", "11 non-overlapping human-review documents"],
      [18, "Professional boundary", "Scope of CBAMValid preparation versus verifier-reserved work"],
    ],
  };
  ...
  return [
    pdf("CBAMValid Verification Readiness & Evidence Assurance Dossier.pdf", "CBAMValid Verification Readiness & Evidence Assurance Dossier", "Enterprise verifier-preparation dossier with one authoritative readiness state and the complete workpaper result set", [
      ...
      { heading: "Primary-document architecture", sectionNumber: 17, pageBreakBefore: true, paragraphs: ["The sealed package contains 11 foregrounded human-review documents with non-overlapping roles. Remaining components are machine-readable registers, cryptographic trust files, the verifier workbook and immutable supporting evidence."], table: documentRoleTable },
