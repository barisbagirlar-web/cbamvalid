...
export function createVerifierGradeCase(): AuditReadyCase {
  return {
    ...
    productionProcesses: [
      {
        ...
        annexIiDefinition: "Annex II iron and steel production process covering BF-BOF route within the controlled installation boundary.",
    ...
    sourceStreamRegister: [
      ...
      {
        streamId: "STREAM-EL-001",
        name: "Electricity import meter stream",
        category: "MAJOR",
    ...
    emissionSourceRegister: [
      {
        sourceId: "ES-BF-STACK-001",
        name: "Blast furnace / process stack",
        gas: "CO2",
        linkedProcessId: "PROC-BF-BOF-001",
        linkedStreamId: "STREAM-FUEL-001",
      },
      {
        sourceId: "ES-COMB-001",
        name: "Combustion units",
        gas: "CO2",
        linkedProcessId: "PROC-BF-BOF-001",
        linkedStreamId: "STREAM-FUEL-001",
      },
    ...
    meterRegister: [
      {
        meterId: "TEST-METER-FUEL-001",
        description: "Fuel flow meter for process combustion stream",
        meterType: "FUEL",
        calibrationDate: "2025-12-15",
        calibrationValidityEnd: "2027-01-14",
        calibrationEvidenceId: EVIDENCE_4_ID,
      ...
      {
        meterId: "TEST-METER-EL-001",
        description: "Electricity import meter",
