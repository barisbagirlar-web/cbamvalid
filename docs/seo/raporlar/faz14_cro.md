...
- Public users can allow/decline analytics and reopen privacy settings; ad storage/personalization remain denied.
...
- Runtime public layout changes require exact merged-SHA production deployment after merge.
