...
|---|---|---|
| BOOTSTRAP | completed | PR #175/#177/#179/#185/#189/#190/#200/#202/#208/#214 control corrections; all merged only after repository gates |
...
| FAZ 14 | completed | PR candidate; `/product` intent rubric 44/49 vs config gate 35; Consent Mode v2 default-denied + public choice manager; experiment lock/A3, no-peeking, variant-index guards; no experiment started/no fabricated lift; `data/seo/cro_experiments.json`; `data/seo/invariant-results/faz-14.json` |
| FAZ 15 | pending | — |
| FAZ 16 | pending | — |
| FAZ 17 | pending | — |
| FAZ 18 | pending | — |
...
- FAZ 14: **DEPLOY AFTER MERGE / EXTERNAL RELEASE EXECUTION** — public Consent Mode v2/privacy controls change runtime output; live validation follows deployment.
